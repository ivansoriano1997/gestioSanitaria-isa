...
class Hospital {
    ...
    donarDaltaPacient(llitPacient) {
        alert("S'ha donat d'alta el pacient " + this.pacientsIngressats[llitPacient].nom + " de la malaltia " + this.pacientsIngressats[llitPacient].malaltia.toString());
